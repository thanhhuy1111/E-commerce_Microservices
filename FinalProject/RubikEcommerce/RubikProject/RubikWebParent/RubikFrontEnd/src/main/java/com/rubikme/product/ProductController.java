...
public class ProductController {
	...
	public String viewProductByPage(Model model, @PathVariable("pageNum") int pageNum, HttpServletRequest request) {
	...
	public String viewProdutDetail(@PathVariable("product_alias") String alias, Model model, String sortField,
			String sortDir, HttpServletRequest request) {
		try {
