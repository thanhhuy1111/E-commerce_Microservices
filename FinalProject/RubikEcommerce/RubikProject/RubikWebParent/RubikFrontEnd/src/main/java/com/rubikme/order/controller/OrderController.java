...
public class OrderController {
	...
	public String listByPage(@PathVariable(name = "pageNum") int pageNum, Model model,
			...
			HttpServletRequest request, @AuthenticationPrincipal CustomerUserDetails loggerUser) {
	...
	public String viewOrderDetail(@PathVariable("id") Integer id, Model model, RedirectAttributes ra,
			HttpServletRequest request, @AuthenticationPrincipal CustomerUserDetails loggerUser) {
		Customer customer = getCustomerAuthentication(request);
		List<CartItem> listCartItems = cartService.listCartItems(customer);
